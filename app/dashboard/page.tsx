...
const activityData = [
  { name: "Sem 1", transacciones: 24 },
  { name: "Sem 2", transacciones: 13 },
  { name: "Sem 3", transacciones: 98 },
  { name: "Sem 4", transacciones: 39 },
]
          ...
          <Card className="p-6 border-l-4 border-l-primary">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-green-600 mt-2">+3 nuevos</p>
              </div>

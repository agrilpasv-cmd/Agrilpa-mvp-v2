    ...
    const fetchOrderDetails = async () => {
      try {
        ...
        if (response.ok) {
          ...
          // Construct formatted order object
          // Taxes are hardcoded logic for now based on previous mock data or country map
          // Ideally taxes should be saved in DB or calculated consistently
          const taxRate = 0.15
          const subtotal = order.price_usd / (1 + taxRate) // Approximation if total saved includes tax, otherwise adjust logic
          ...
          setPedido({
            ...
            detalles: {
              ...
              subtotal: new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(order.price_usd), // Assuming price_usd is total
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-2">No pudimos encontrar los detalles de este pedido.</p>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left Side - Product & Detailed Info */}
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="capitalize">{pedido.shippingMethod === 'avion' ? 'Aéreo (Avión)' : 'Marítimo (Barco)'}</p>
                </div>
              </div>

...
export async function GET() {
    try {
        ...
        const { data: products, error: productsError } = await supabaseAdmin
            .from("user_products")
            .select("id, user_id, title, category, description, country, state, price, currency, quantity, min_order, packaging, packaging_size, certifications, maturity, contact_method, contact_info, incoterm, created_at, views, is_visible, shipping_unit_type, container_size")

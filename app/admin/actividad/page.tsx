...
export default function ActividadAdminPage() {
  ...
  const getActivityIcon = (type: string) => {
    switch (type) {
      ...
      case 'navigation': return <ExternalLink className="w-4 h-4 text-gray-400" />
  ...
  return (
    <div className="p-4 md:p-8 w-full max-w-[1600px] mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Actividad de Usuarios</h1>
          <p className="text-muted-foreground mt-1">Monitorea en tiempo real las acciones y navegación de los usuarios.</p>
        </div>
                    ...
                    <tr key={activity.id} className="hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="p-4">
                        <div className="flex items-center gap-2">
                          <Badge variant="secondary" className={`gap-1.5 font-medium ${getActivityBadge(activity.activity_type)}`}>
                      ...
                      <td className="p-4">
                        <div className="flex items-center gap-1 text-xs text-gray-400 bg-gray-50 px-2 py-1 rounded-md w-fit">

                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            {(product as any).sellerIsPro && (
                              <div className="flex items-center justify-center w-5 h-5 rounded-full bg-amber-50 border border-amber-200 shadow-sm animate-in zoom-in duration-300" title="Usuario PRO">

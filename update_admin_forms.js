...
try { update('app/admin/publicaciones/nueva/page.tsx'); } catch (e) { console.error(e) }
try { update('app/admin/publicaciones/[id]/editar/page.tsx'); } catch (e) { console.error(e) }
